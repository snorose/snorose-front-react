...
export default function ErrorPage() {
  ...
  const HTTP_ERROR_STATUS = ERRORS.flatMap((error) => error.status);
  const imagePath = HTTP_ERROR_STATUS.includes(error.status)
    ? require(`../../assets/images/error${error.status}.png`)
    : '';
